...
module.exports = {
    ...
    async handleTournamentCreation(interaction) {
        ...
        try {
            ...
            const tournament = new Tournament(title, description, dateTime, maxTeams);
            ...
            await interaction.reply({ content: 'An error occurred while creating the tournament.', ephemeral: true });
        }
    },
    ...
    async finalizeTournament(interaction) {
        try {
            ...
            await interaction.reply({ content: 'An error occurred while finalizing the tournament.', ephemeral: true });
        }
    }
};